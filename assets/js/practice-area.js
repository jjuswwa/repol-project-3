document.addEventListener("DOMContentLoaded", function () {
  ...
  // Function to hide all practice area
  ...
  const totalPages = Math.ceil(services.length / elementsPerPage);
  ...
  function generateMobilePaginationLinks(currentPage) {
    ...
    if (totalPages > 1) {
      ...
      // Display current page number with gold background
      html += `<li class="page-item active" ><span class="page-link" style="background-color: #cdba6d; border: none">${currentPage} / ${totalPages}</span></li>`;
